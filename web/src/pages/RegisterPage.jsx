      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-6">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-3 text-gray-600">创建账号，开启你的 AI 创作之旅</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-5 py-4 rounded-xl border-2 transition-all duration-300 outline-none ${
                    errors.password ? 'border-red-500' : 'border-gray-200 focus:border-purple-500 focus:ring-4 focus:ring-purple-100'
                  }`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-5 py-4 rounded-xl border-2 transition-all duration-300 outline-none ${
                    errors.confirmPassword ? 'border-red-500' : 'border-gray-200 focus:border-purple-500 focus:ring-4 focus:ring-purple-100'
                  }`}
                  placeholder="请再次输入密码"
                  required
                />
              ...
              <div className="flex items-start">
                ...
                <span className="ml-2 text-sm text-gray-600">
                  我已阅读并同意{' '}
                  <a href="#" className="text-purple-600 hover:text-purple-700">服务条款</a>
                  {' '}和{' '}
