...
function ComicCreatePage() {
  const { user } = useUser();
  const [activeTab, setActiveTab] = useState('comic'); // 'comic' | 'video'
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-cyan-50 to-teal-50 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 pt-24 pb-20">
        ...
        <div className="max-w-6xl mx-auto mb-8">
          <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-2 inline-flex shadow-sm">
            <button
